...
function FiltroSetor({
  ...
  function clica(opcao) {
    ...
    const nome = opcao.setor.setor_nome;
          ...
          >
            ...
            >
              {(() => {
                ...
                const unicos = descricoes.filter((d) => {
                  const nome = d?.setor?.setor_nome;
                ...
                return unicos.map((descricao) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="truncate">{descricao?.setor?.setor_nome}</span>
                    </button>
                  );
                });
              })()}
