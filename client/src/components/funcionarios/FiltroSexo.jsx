...
function FiltroSexo({ setFuncionarioFiltro, funcionarioFiltro }) {
  ...
  function clica(sexo) {
    const valor = sexo.toLowerCase();
    const selecionado = funcionarioFiltro.some((s) => s.sexo_nome === valor);
    setFuncionarioFiltro((prev) =>
      selecionado
        ? prev.filter((s) => s.sexo_nome !== valor)
        : [...prev, { sexo_nome: valor, filtrado: true }]
    );
  }
                  ...
                  return (
                    <li key={sexo}>
                      ...
                      >
                        ...
                        <span className="block truncate">{sexo}</span>
                      </button>
                    </li>
                  );
                })}
