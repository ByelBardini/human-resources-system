      ...
      <div className="mt-5 flex justify-center gap-6">
        ...
        {inativos ? (
          <button
            ...
            className="absolute bottom-6 right-6 px-3 py-2 rounded-lg bg-red-500/15 border border-red-400/30 text-red-200 hover:bg-red-500/25 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
          >
          ...
          <button
            onClick={buscaInativos}
            className="absolute bottom-6 right-6 px-3 py-2 rounded-lg bg-green-500/15 border border-green-400/30 text-green-200 hover:bg-green-500/25 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
          >
