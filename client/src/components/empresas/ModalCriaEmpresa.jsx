...
function ModalCriaEmpresa({
  ...
  async function criaEmpresa() {
    ...
    try {
      ...
      mostrarAviso("sucesso", "Empresa cadastrada com sucesso!", true);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="space-y-4"
          onKeyDown={(e) => e.key === "Enter" && criaEmpresa()}
        >
          <div>
...
export default memo(ModalCriaEmpresa);
